...
import argparse
import os, re, copy, pprint, substitution, makeWordPatterns
...
#LETTERS = ''.join(chr(i) for i in range(32,127))
...
def main():
    ...
    with open(args.input) as file:
        ...
        with open('output/cry_sub_out.txt', 'w') as f:
            print(hackedMessage, file=f)
            print('Full text in output/cry_sub_out.txt')
...
def decryptWithCipherletterMapping(ciphertext, letterMapping):
    ...
    return substitution.decryptMessage(key, ciphertext, LETTERS)
